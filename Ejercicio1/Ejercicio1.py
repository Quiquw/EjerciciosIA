...
with open("annual_json.json", "r") as temp_data:
    temp_data = json.load(temp_data)
with open("co2-annmean-mlo_json.json", "r") as co2_data:
    co2_data = json.load(co2_data)
...
y_pred2 = regr.predict(np.array([[0.8]]))
